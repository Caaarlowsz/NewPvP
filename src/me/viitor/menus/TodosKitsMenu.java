...
public class TodosKitsMenu {
	...
	public static void inventory(Player p){
		...
		menu.addItem(criarItemMenu(Material.WOOD_AXE, "§aThor", new String[] {"§7Vire o thor e lançe raios", "§7em seus inimigos"}));
		...
		menu.addItem(criarItemMenu(Material.FIRE, "§aMagma", new String[] {"§7Ao bater em seu inimigo", "§7tenha chançe de colocar fogo nele"}));
		menu.addItem(criarItemMenu(Material.STICK, "§aGrandpa", new String[] {"§7Jogue seu inimigo longe", "§7usando seu stick"}));
		menu.addItem(criarItemMenu(Material.NETHER_STAR, "§aAjnin", new String[] {"§7Ao apertar shift o ultimo", "§7jogador hitado Ã© teleportado a você"}));
