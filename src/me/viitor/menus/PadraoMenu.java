...
public class PadraoMenu {
	...
	public static void inventory(Player p){
		...
		kVoltar.setLore(Arrays.asList("§7Volte para o menu", "§7dos kits que vocÃª possui", " "));
		...
		menu.addItem(criarItemMenu(Material.LEASH, "§aGrappler", new String[] {"§7Use seu laÃ§o para se", "§7locomover pelo mapa"}));
		}
		...
		menu.addItem(criarItemMenu(Material.WOOD_AXE, "§aThor", new String[] {"§7Vire o thor e lanÃ§e raios", "§7em seus inimigos"}));
		}
		...
		menu.addItem(criarItemMenu(Material.FIRE, "§aMagma", new String[] {"§7Ao bater em seu inimigo", "§7tenha chanÃ§e de colocar fogo nele"}));
		}
		...
		menu.addItem(criarItemMenu(Material.NETHER_STAR, "§aAjnin", new String[] {"§7Ao apertar shift o ultimo", "§7jogador hitado Ã© teleportado a vocÃª"}));
		}
